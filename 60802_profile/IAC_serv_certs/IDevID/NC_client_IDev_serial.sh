...
$OPENSSL ecparam -name prime256v1  -genkey -out ee_hersteller_ser_key.key
 ...
 $OPENSSL  x509 -req -in ee_hersteller_ser_req.csr -CA root_hersteller_ip_IDev.crt -CAkey root_hersteller_IDev_ip_key.key \
    -CAcreateserial -extfile ca.cnf -extensions usr_cert   -out ee_hersteller_ser.crt
$OPENSSL ec -in ee_hersteller_ser_key.key -pubout >IDev_pub_key_ser.pub
